...
export default function MenuList() {
  ...
  return (
    <div
      style={{ zIndex: 201 }}
      className="w-14 py-2 absolute top-1/2 -translate-y-1/2 mt-1 left-2.5 bg-background/80 backdrop-filter backdrop-blur-lg rounded-lg shadow-lg flex flex-col items-center"
    >
      <div className="relative group w-full flex justify-center">
        ...
        <span className="pointer-events-none absolute left-full top-1/2 -translate-y-1/2 ml-2 bg-gray-900 text-white text-xs rounded px-2 py-1 opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap shadow-lg z-10">
          Uploads
        </span>
      </div>
      <div className="relative group w-full flex justify-center">
